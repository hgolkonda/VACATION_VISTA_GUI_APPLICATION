...
public class BookVehiclePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttonPanel.setBackground(new java.awt.Color(140, 82, 255));

        btnManageVehicle.setBackground(new java.awt.Color(157, 193, 131));
        btnManageVehicle.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        btnManageVehicle.setForeground(new java.awt.Color(140, 82, 255));
        ...
        btnRequestQueue.setBackground(new java.awt.Color(157, 193, 131));
        ...
        btnHome.setBackground(new java.awt.Color(157, 193, 131));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/car.jpg"))); // NOI18N
